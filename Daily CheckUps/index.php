...
if (isset($_POST['submit'])) {
    ...
    $string2 = [
        ...
        'swollen_extremeties',
        'swollen_legs',
        'throat_irritation,toxic_look_(typhos)',
        'ulcers_on_tongue',
        'unsteadiness',
        'visual_disturbances',
        'vomiting',
    ...
    fwrite($abc, $string3);
    fwrite($abc, $string); // echo $string;
    $command = escapeshellcmd('python checkup.py &');
                    ...
                    <form id="appointment-form" role="form" method="post" action="#">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <button type="submit" class="btn1" id="cf-submit" name="refresh"> <a href="https://docs.google.com/spreadsheets/d/1whL-OO6sV43wgTMOiaa4u__6xz9mM0sIeOqsejNw0qk/edit?usp=sharing">Doctors Available</a> </button>
                            </div>
                        </div>
                    </form>
                </div>
